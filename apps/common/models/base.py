...
from apps.common.model_fields import AppImageField,AppSingleFileField
...
COMMON_NON_NULLABLE_FIELD_CONFIG={"blank": True,"null": False}
...
class AppFileModel(FileOnlyModel):
           
    file = AppSingleFileField(
        max_size=10,
        upload_to=file_upload_path,
        blank=True, 
        null=True,
...
class IdentityBaseModel(models.Model):
    """
    Contains name field.
